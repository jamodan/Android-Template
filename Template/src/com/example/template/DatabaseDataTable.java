...
public class DatabaseDataTable 
{
	...
	public static void insert(String name, String value, String description)
	{
	 ...
	 */
	public static int update(String name, String value, String description, String selection, String[] selectionArgs)
	{
